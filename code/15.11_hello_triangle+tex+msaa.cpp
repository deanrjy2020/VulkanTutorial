...
private:
    ...
    void createRenderPass() {
        // redner to this color attachment with 4x MSAA
        ...
        // resolve to this attachment ended up with 1x MSAA
    ...
    void createColorResources() {
        ...
        createImage(swapChainExtent.width, swapChainExtent.height, msaa, colorFormat,
    ...
    void createTextureSampler() {
        ...
        VkSampleCountFlags colorSampleCounts = properties.limits.framebufferColorSampleCounts;
